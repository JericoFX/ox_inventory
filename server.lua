...
lib.callback.register('ox_inventory:hasGroupAccess', function(source, requiredGroups)
	local inventory = Inventory(source)
	if not inventory or not inventory.player then return false end

	return server.hasGroup(inventory, requiredGroups)
end)
